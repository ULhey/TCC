    ...
    <main>
        ...
        <section class="categoria">
            <div class="container">
                ...
                <form id="cardapio" action="categoriaatualizarAction.php" method='post'>
                    <fieldset>

                        <legend>Alterar</legend>
                        <div class="input-block">
                            <label for="">Categoria*</label>
                            <input name="txtCat" value="<?php echo $_GET['id'] ?>">
                        </div> <br>

                        <div class="input-block">
                            <label for="">Nome*</label>
                            <input name="txtNome" value="<?php echo $_GET['nomeCategoria'] ?>">
                        </div> <br>
