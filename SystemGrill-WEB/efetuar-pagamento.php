...
<head>
    ...
    <title>SystemGrill - Efetuar Pagamento</title>
</head>
    ...
    <main>
        ...
        <section class="pagamento">
            <div class="container">
                ...
                <form id="usuario" action="post">
                    <fieldset>

                        <div class="input-block">
                            <label for="">Valor total*</label>
                            <input name="txtValorTotal" value="<?php echo $_GET['valor_total'] ?>">
                        </div>

                        <div class="input-block">
                            <label>Metodo de pagamento*</label>
                            <input name="txtMetodo">
                        </div>
                        ...
                        <div class="botoes-menu-pagamento">
                            <div class="botoes-menu-pagamento">
                                <a href="/finalizar.php" class="btn-menu-pagamento">FINALIZAR</a>
                            </div>
                        </div>
