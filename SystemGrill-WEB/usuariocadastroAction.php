...
<body>
    <div class="w3-padding w3-display-middle">
        ...
        $sql = "INSERT INTO usuario (senhaUsuario, nomeUsuario, email, cpf, cargoUsuario)
        VALUES ('" . $_POST['txtSenha'] . "', '" . $_POST['txtNome'] . "','" . $_POST['txtEmail'] . "','" . $_POST['txtCPF'] . "','" . $_POST['txtFuncao'] . "')";
