            ...
            <div class="container">
                ...
                if ($resultado != null)
                    foreach ($resultado as $linha) {
                        ...
                        echo '<td align="center">' . $linha['precoProduto'] . '</td>';
                        echo '<td align="center"><a href="excluir-cardapio.php?id=' . $linha['idProduto'] . '&descricaoProduto=' . $linha['descricaoProduto'] . '&idCategoria=' . $linha['idCategoria'] . '&precoProduto=' . $linha['precoProduto'] . '"><i class="fa fa-user-times w3-large w3-text-blue"></i> </a></td></td>';
                        echo '<td align="center"><a href="alterar-cardapio.php?id=' . $linha['idProduto'] . '&descricaoProduto=' . $linha['descricaoProduto'] . '&idCategoria=' . $linha['idCategoria'] . '&precoProduto=' . $linha['precoProduto'] . '"><i class="fa fa-refresh w3-large w3-text-blue""></i></a></td></td>';
                        echo '</tr>';
                    }
                echo '
                    </table>
