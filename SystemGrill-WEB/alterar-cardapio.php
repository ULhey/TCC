    ...
    <main>
        ...
        <section class="cardapio">
            <div class="container">
                ...
                <form id="cardapio" action="cardapioatualizarAction.php" method='post'>
                    <fieldset>
                        ...
                        <div class="input-block">
                            ...
                            <input name="txtDescricao" value="<?php echo $_GET['descricaoProduto'] ?>">
                        </div>
                        ...
                        <div class="input-block">
                            ...
                            <input name="txtPreco" value="<?php echo $_GET['precoProduto'] ?>">
                        </div>
