            ...
            <div class="container">
                ...
                <div class="botoes-menu-categoria">
                    <div class="botoes-menu-categoria">
                        ...
                        <a href="/consultar-categoria.php" class="btn-menu-categoria">Consultar</a>
                    </div>
                </div>
                <div class="titulo">
                    <h2>EXLUIR CATEGORIA - ID: <?php echo " " . $_GET['id'] ?> </h2>
                </div>

                <form id="cardapio" action="categoriaexcluirAction.php" method='post'>
                    <input name="txtCat" class="input-block" type="hidden" value="<?php echo $_GET['id'] ?>">
                    <br>

                    <div class="input-block">
                        <label style="font-weight: bold;">Categoria</label>
                        <input name="txtCat class=" input-block" disabled value="<?php echo $_GET['id'] ?>">
                        <br>
                    </div>

                    <div class="input-block">
                        <label style="font-weight: bold;">Nome</label>
                        <input name="txtNome" class="input-block" disabled value="<?php echo $_GET['nomeCategoria'] ?>">
                        <br>
                    </div>
